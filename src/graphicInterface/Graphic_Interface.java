...
public class Graphic_Interface extends JFrame{
	...
	private void initializeC(WizardHandlerJPA oz, User admin) {
		...
		btnNewClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(guts.getClientIdThrouUserId(admin.getId())==-1) {
					...
					JOptionPane.showMessageDialog(null, "You are already registered as a client.");
				}
			}
		});
		btnEditClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(guts.getClientIdThrouUserId(admin.getId())!=-1) {
					EditClient c=new EditClient(guts,admin);
				}else {
					JOptionPane.showMessageDialog(null, "You are not registered as a client.");
				}
			}
		});
	...
	private void initialize(WizardHandlerJPA oz, User logged) {
		...
		mntmClient_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				User admin =new User ("def","pass");
				admin.setUserType(oz.getStatus(1));
				EditClient c= new EditClient(guts,admin);
			}
		});
	...
	public void NewEntryOneTable (User admin) {
		panel_1.removeAll();
